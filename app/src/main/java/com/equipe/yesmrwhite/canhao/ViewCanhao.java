...
public class ViewCanhao extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public ViewCanhao(Context context, AttributeSet attrs) {
        ...
        tabelaPeriodica = new TabelaPeriodica(context);
        ...
        for (int i = 0; i < TARGET_PIECES; i++) {
            if (!hitStates[i]) {
                if (i % 2 != 0) {
                    ...
                    canvas.drawText("Na",(int)(currentPoint.x-screenWidth/40), (int) (currentPoint.y + pieceLength/2+screenWidth/60), elementoTexto);
                } else {
